...
const fetchProjectsFromAPI = async (url, setProjects, setError, setLoading) => {
    try {
...
const ProjectsList = () => {
    ...
    useEffect(() => {
        fetchProjectsFromAPI('http://localhost:5000/api/projects', setProjects, setError, setLoading);
    }, []);
    ...
    const handleEditSubmit = (updatedProject) => {
        setProjects((prevProjects) =>
            prevProjects.map((p) => (p.id === selectedProject.id ? { ...p, ...updatedProject } : p))
        );
        closeEditForm();
    };
                ...
                <div className='NavigationBox'>
                    <div className='Navigation'>
                        <div className='Box1'>
                            ...
                            <div className='TextTitle'><h2>Проекты</h2></div>
                        </div>
                        <div className='search-bar-container'>
                            <div className='search-input-wrapper'>
                                ...
                                />
                                <CiSearch className='SearchIcon' style={{ right: '281px' }} />
                            </div>
                        ...
                        {filteredProjects.map((item, index) => (
                            <div key={item._id}>
                                <div className='List-div'>
                                    <Link className='Main-item-div' to={`${item._id}`}>
                                        <p className='P-date'>{item.project_number}</p>
